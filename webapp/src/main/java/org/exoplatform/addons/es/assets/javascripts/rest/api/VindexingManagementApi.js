...
if ( typeof define === "function" && define.amd ) {     
	define(['jquery', 'ApiClient'], function($, ApiClient) {
...
var VindexingManagementApi = function VindexingManagementApi() {
  ...
  self.getConnectors = function(jsonp, returnSize, callback) {
    ...
    apiClient.invokeAPI(path, "GET", queryParams, postBody, postBinaryBody, headerParams, formParams, null, null, null);
...
, "\\{" + "connectorType" + "\\}", apiClient.escapeString(connectorType.toString()));
...
, "\\{" + "connectorType" + "\\}", apiClient.escapeString(connectorType.toString()));
    ...
    apiClient.invokeAPI(path, "PUT", queryParams, postBody, postBinaryBody, headerParams, formParams, null, null, null);
   ...
   * @return void
   */
  self.addOperation = function(callback) {
    ...
    apiClient.invokeAPI(path, "POST", queryParams, postBody, postBinaryBody, headerParams, formParams, null, null, null);
  ...
  self.deleteOperations = function(callback) {
    ...
    apiClient.invokeAPI(path, "DELETE", queryParams, postBody, postBinaryBody, headerParams, formParams, null, null, null);
